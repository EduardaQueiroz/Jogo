...
public class Camada {
	...
	public Camada(String nomeMapaMatriz) {
		...
		try {
			...
			tileSet = ImageIO.read(getClass().getClassLoader().getResourceAsStream("view/imagens/tilesetJogo.png"));
	...
	public int[][] carregarMatriz(String nomeMapa) {
		...
		InputStream input = getClass().getClassLoader().getResourceAsStream("txts/"+nomeMapa);

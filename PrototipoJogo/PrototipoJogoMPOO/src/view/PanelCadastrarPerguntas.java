...
public class PanelCadastrarPerguntas extends JPanel{
	...
	public PanelCadastrarPerguntas() {
		...
		fonte1 = new Font("Times new Roman", Font.ITALIC, 20);
		fonte2 = new Font("Times new Roman", Font.BOLD, 20);
		...
		cbRespostaCerta.addItem("Opção 1");
		cbRespostaCerta.addItem("Opção 2");
		cbRespostaCerta.addItem("Opção 3");
		
		cbFase.addItem("Briófitas");
		cbFase.addItem("Pteridófitas");
		cbFase.addItem("Gimnospermas");
		cbFase.addItem("Angiospermas");
		
		txaPergunta.setFont(new Font("Times new Roman", Font.ITALIC, 20));
		tfOpUm.setFont(fonte1);
		tfOpDois.setFont(fonte1);
		tfOpTres.setFont(fonte1);
		
		cbRespostaCerta.setFont(fonte2);
		cbFase.setFont(fonte2);
	...
	public JComboBox<String> getCbFase() {
		return cbFase;
	}
